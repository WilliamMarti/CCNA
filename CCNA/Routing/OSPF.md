...
2. Highest OSPF Configured Router ID
3. Highest Loopback Address
4. Physical IP Address
...
**Nonbroadcast** and **point-to-multipoint nonbroadcast** do not alow multicast packets. Need to use ospf neighbor command